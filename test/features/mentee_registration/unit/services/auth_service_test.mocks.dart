...
// in smp_mentor_mentee_mobile_app/test/features/mentee_registration/unit/services/auth_service_test.dart.
...
import 'package:smp_mentor_mentee_mobile_app/models/user.dart' as _i11;
...
/// A class which mocks [RealTimeUserService].
///
/// See the documentation for Mockito's code generation for more information.
class MockRealTimeUserService extends _i1.Mock
    implements _i10.RealTimeUserService {
  MockRealTimeUserService() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i7.Stream<List<_i11.User>> get usersStream =>
      (super.noSuchMethod(
            Invocation.getter(#usersStream),
            returnValue: _i7.Stream<List<_i11.User>>.empty(),
          )
          as _i7.Stream<List<_i11.User>>);

  @override
  _i7.Stream<_i10.ConnectionState> get connectionStateStream =>
      (super.noSuchMethod(
            Invocation.getter(#connectionStateStream),
            returnValue: _i7.Stream<_i10.ConnectionState>.empty(),
          )
          as _i7.Stream<_i10.ConnectionState>);

  @override
  _i10.ConnectionState get connectionState =>
      (super.noSuchMethod(
            Invocation.getter(#connectionState),
            returnValue: _i10.ConnectionState.disconnected,
          )
          as _i10.ConnectionState);

  @override
  List<_i11.User> get currentUsers =>
      (super.noSuchMethod(
            Invocation.getter(#currentUsers),
            returnValue: <_i11.User>[],
          )
          as List<_i11.User>);

  @override
  void startListening(String? universityPath) => super.noSuchMethod(
    Invocation.method(#startListening, [universityPath]),
    returnValueForMissingStub: null,
  );
  ...
  @override
  _i7.Future<String?> createUser(
    String? universityPath,
    Map<String, dynamic>? userData,
  ) =>
      (super.noSuchMethod(
            Invocation.method(#createUser, [universityPath, userData]),
            returnValue: _i7.Future<String?>.value(),
          )
          as _i7.Future<String?>);

  @override
  _i7.Future<bool> deleteUser(String? universityPath, String? userId) =>
      (super.noSuchMethod(
            Invocation.method(#deleteUser, [universityPath, userId]),
            returnValue: _i7.Future<bool>.value(false),
          )
          as _i7.Future<bool>);

  @override
  _i11.User? getUserById(String? userId) =>
      (super.noSuchMethod(Invocation.method(#getUserById, [userId]))
          as _i11.User?);

  @override
  List<_i11.User> getUsersByType(String? userType) =>
      (super.noSuchMethod(
            Invocation.method(#getUsersByType, [userType]),
            returnValue: <_i11.User>[],
          )
          as List<_i11.User>);
...
class MockCloudFunctionService extends _i1.Mock
    implements _i12.CloudFunctionService {
  MockCloudFunctionService() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i7.Future<Map<String, dynamic>> initializeUniversity({
    ...
    required String? universityName,
      ...
      (super.noSuchMethod(
            Invocation.method(#initializeUniversity, [], {
              #state: state,
              #city: city,
              #campus: campus,
  ...
  @override
  _i7.Future<Map<String, dynamic>> getUniversities() =>
      (super.noSuchMethod(
            Invocation.method(#getUniversities, []),
            returnValue: _i7.Future<Map<String, dynamic>>.value(
              <String, dynamic>{},
            ),
          )
  ...
  @override
  _i7.Future<Map<String, dynamic>> createUserAccount({
    ...
    String? acknowledgmentSigned,
      ...
      (super.noSuchMethod(
            Invocation.method(#createUserAccount, [], {
  ...
  @override
  _i7.Future<Map<String, dynamic>> updateUserAccount({
    required String? universityPath,
  ...
  @override
  _i7.Future<Map<String, dynamic>> getUsersList({
    required String? universityPath,
  }) =>
      (super.noSuchMethod(
  ...
  @override
  _i7.Future<Map<String, dynamic>> deleteUserAccount({
    required String? universityPath,
    required String? userId,
  }) =>
      (super.noSuchMethod(
  ...
  @override
  _i7.Future<Map<String, dynamic>> assignMentor({
    required String? universityPath,
    required String? mentorId,
    required String? menteeId,
  }) =>
      (super.noSuchMethod(
            Invocation.method(#assignMentor, [], {
              #universityPath: universityPath,
              #mentorId: mentorId,
              #menteeId: menteeId,
            }),
  ...
  @override
  _i7.Future<Map<String, dynamic>> scheduleMeeting({
    required String? universityPath,
    required String? mentorId,
    required String? menteeId,
    ...
    String? availabilityId,
      ...
      (super.noSuchMethod(
            Invocation.method(#scheduleMeeting, [], {
              #universityPath: universityPath,
              #mentorId: mentorId,
              #menteeId: menteeId,
              #startTime: startTime,
  ...
  @override
  _i7.Future<Map<String, dynamic>> updateMeetingDetails({
    required String? universityPath,
    ...
    String? status,
      ...
      (super.noSuchMethod(
            Invocation.method(#updateMeetingDetails, [], {
              #universityPath: universityPath,
              #meetingId: meetingId,
              #startTime: startTime,
              #endTime: endTime,
  ...
  @override
  _i7.Future<Map<String, dynamic>> cancelMeeting({
    required String? universityPath,
    required String? meetingId,
    String? reason,
  }) =>
      (super.noSuchMethod(
            Invocation.method(#cancelMeeting, [], {
              #universityPath: universityPath,
              #meetingId: meetingId,
              #reason: reason,
            }),
  ...
  @override
  _i7.Future<Map<String, dynamic>> createMeeting({
    required String? universityPath,
    required String? mentorId,
    required String? menteeId,
  ...
  @override
  _i7.Future<Map<String, dynamic>> updateMeeting({
    required String? universityPath,
    required String? meetingId,
    String? date,
    String? startTime,
  ...
  @override
  _i7.Future<Map<String, dynamic>> acceptMeeting({
    required String? universityPath,
    required String? meetingId,
  }) =>
      (super.noSuchMethod(
            Invocation.method(#acceptMeeting, [], {
              #universityPath: universityPath,
              #meetingId: meetingId,
            }),
            returnValue: _i7.Future<Map<String, dynamic>>.value(
  ...
  @override
  _i7.Future<Map<String, dynamic>> rejectMeeting({
    required String? universityPath,
    required String? meetingId,
    String? reason,
  }) =>
      (super.noSuchMethod(
            Invocation.method(#rejectMeeting, [], {
              #universityPath: universityPath,
              #meetingId: meetingId,
              #reason: reason,
            }),
  ...
  @override
  _i7.Future<Map<String, dynamic>> setMentorAvailability({
    required String? universityPath,
    required String? mentorId,
    required String? day,
    required List<Map<String, dynamic>>? slots,
      ...
      (super.noSuchMethod(
            Invocation.method(#setMentorAvailability, [], {
              #universityPath: universityPath,
              #mentorId: mentorId,
              #day: day,
              #slots: slots,
  ...
  @override
  _i7.Future<Map<String, dynamic>> getMentorAvailability({
    required String? universityPath,
    required String? mentorId,
    String? day,
  }) =>
      (super.noSuchMethod(
            Invocation.method(#getMentorAvailability, [], {
              #universityPath: universityPath,
              #mentorId: mentorId,
              #day: day,
            }),
  ...
  @override
  _i7.Future<Map<String, dynamic>> getAvailableSlots({
    required String? universityPath,
    required String? mentorId,
    String? day,
  }) =>
      (super.noSuchMethod(
            Invocation.method(#getAvailableSlots, [], {
              #universityPath: universityPath,
              #mentorId: mentorId,
              #day: day,
            }),
  ...
  @override
  _i7.Future<Map<String, dynamic>> removeAvailabilitySlot({
    required String? universityPath,
    required String? mentorId,
    required String? day,
    required String? slotStart,
      ...
      (super.noSuchMethod(
            Invocation.method(#removeAvailabilitySlot, [], {
              #universityPath: universityPath,
              #mentorId: mentorId,
              #day: day,
              #slotStart: slotStart,
  ...
  @override
  _i7.Future<Map<String, dynamic>> requestMeeting({
    required String? universityPath,
    required String? mentorId,
    required String? menteeId,
    required String? date,
    ...
    String? location,
      ...
      (super.noSuchMethod(
            Invocation.method(#requestMeeting, [], {
              #universityPath: universityPath,
              #mentorId: mentorId,
              #menteeId: menteeId,
              #date: date,
  ...
  @override
  _i7.Future<Map<String, dynamic>> createChatConversation({
    required String? user1Id,
    required String? user2Id,
    String? mentorshipId,
  }) =>
      (super.noSuchMethod(
            Invocation.method(#createChatConversation, [], {
              #user1Id: user1Id,
              #user2Id: user2Id,
  ...
  @override
  _i7.Future<Map<String, dynamic>> sendChatMessage({
  ...
  @override
  _i7.Future<Map<String, dynamic>> markChatMessagesRead({
    required String? conversationId,
    required List<String>? messageIds,
  }) =>
      (super.noSuchMethod(
            Invocation.method(#markChatMessagesRead, [], {
              #conversationId: conversationId,
  ...
  @override
  _i7.Future<Map<String, dynamic>> updateChatSettings({
    required String? conversationId,
    required Map<String, dynamic>? settings,
  }) =>
      (super.noSuchMethod(
            Invocation.method(#updateChatSettings, [], {
              #conversationId: conversationId,
              #settings: settings,
            }),
            returnValue: _i7.Future<Map<String, dynamic>>.value(
  ...
  @override
  _i7.Future<Map<String, dynamic>> sendChatMessageOld({
    required String? universityPath,
    ...
    String? recipientId,
      ...
      (super.noSuchMethod(
            Invocation.method(#sendChatMessageOld, [], {
              #universityPath: universityPath,
              #chatId: chatId,
              #message: message,
  ...
  @override
  _i7.Future<Map<String, dynamic>> getChatMessages({
    required String? universityPath,
    required String? chatId,
    int? limit,
    int? offset,
  ...
  @override
  _i7.Future<Map<String, dynamic>> postAnnouncement({
    required String? universityPath,
    ...
    String? time,
      ...
      (super.noSuchMethod(
            Invocation.method(#postAnnouncement, [], {
              #universityPath: universityPath,
              #title: title,
              #content: content,
              #priority: priority,
  ...
  @override
  _i7.Future<Map<String, dynamic>> createProgressReport({
    required String? universityPath,
    required String? menteeId,
    required String? mentorId,
    required String? reportPeriod,
      ...
      (super.noSuchMethod(
            Invocation.method(#createProgressReport, [], {
              #universityPath: universityPath,
              #menteeId: menteeId,
              #mentorId: mentorId,
  ...
  @override
  _i7.Future<Map<String, dynamic>> submitReport({
    required String? universityPath,
  ...
  @override
  _i7.Future<Map<String, dynamic>> checkMenteeAcknowledgment() =>
      (super.noSuchMethod(
            Invocation.method(#checkMenteeAcknowledgment, []),
            returnValue: _i7.Future<Map<String, dynamic>>.value(
              <String, dynamic>{},
            ),
          )
  ...
  @override
  _i7.Future<Map<String, dynamic>> submitMenteeAcknowledgment({
    required String? fullName,
  }) =>
      (super.noSuchMethod(
            Invocation.method(#submitMenteeAcknowledgment, [], {
              #fullName: fullName,
            }),
            returnValue: _i7.Future<Map<String, dynamic>>.value(
              <String, dynamic>{},
  ...
  @override
  _i7.Future<Map<String, dynamic>> syncData({
    required String? universityPath,
  ...
  @override
  _i7.Future<Map<String, dynamic>> healthCheck() =>
      (super.noSuchMethod(
  ...
  @override
  _i7.Future<Map<String, dynamic>> bulkCreateUsers({
    required String? universityPath,
    required List<Map<String, dynamic>>? users,
  }) =>
      (super.noSuchMethod(
            Invocation.method(#bulkCreateUsers, [], {
              #universityPath: universityPath,
              #users: users,
            }),
            returnValue: _i7.Future<Map<String, dynamic>>.value(
  ...
  @override
  _i7.Future<Map<String, dynamic>> bulkAssignMentors({
    required String? universityPath,
    required List<Map<String, dynamic>>? assignments,
  }) =>
      (super.noSuchMethod(
            Invocation.method(#bulkAssignMentors, [], {
              #universityPath: universityPath,
  ...
  @override
  _i7.Future<Map<String, dynamic>> migrateUserSubcollections({
    required String? universityPath,
    List<String>? userIds,
    bool? dryRun = false,
  }) =>
      (super.noSuchMethod(
            Invocation.method(#migrateUserSubcollections, [], {
              #universityPath: universityPath,
              #userIds: userIds,
              #dryRun: dryRun,
            }),
  ...
  String getCurrentUniversityPath() =>
      (super.noSuchMethod(
            Invocation.method(#getCurrentUniversityPath, []),
            returnValue: _i8.dummyValue<String>(
              this,
              Invocation.method(#getCurrentUniversityPath, []),
            ),
  ...
  @override
  _i7.Future<Map<String, dynamic>> createAnnouncement({
    required String? universityPath,
    required String? title,
    required String? content,
    required String? priority,
  ...
  @override
  _i7.Future<Map<String, dynamic>> updateAnnouncement({
    required String? universityPath,
  ...
  @override
  _i7.Future<Map<String, dynamic>> deleteAnnouncement({
    required String? universityPath,
    required String? announcementId,
  }) =>
      (super.noSuchMethod(
  ...
  @override
  _i7.Future<Map<String, dynamic>> getAnnouncements({
    required String? universityPath,
    required String? userType,
    int? limit,
  }) =>
  ...
  @override
  _i7.Future<Map<String, dynamic>> syncUserClaimsOnLogin() =>
      (super.noSuchMethod(
            Invocation.method(#syncUserClaimsOnLogin, []),
            returnValue: _i7.Future<Map<String, dynamic>>.value(
              <String, dynamic>{},
            ),
          )
  ...
  @override
  _i7.Future<Map<String, dynamic>> setCustomClaimsOnRegistration({
    required String? uid,
  }) =>
      (super.noSuchMethod(
            Invocation.method(#setCustomClaimsOnRegistration, [], {#uid: uid}),
            returnValue: _i7.Future<Map<String, dynamic>>.value(
              <String, dynamic>{},
            ),
          )
  ...
  @override
  _i7.Future<Map<String, dynamic>> syncUserClaimsForUniversity({
    required String? universityPath,
  }) =>
      (super.noSuchMethod(
            Invocation.method(#syncUserClaimsForUniversity, [], {
              #universityPath: universityPath,
            }),
            returnValue: _i7.Future<Map<String, dynamic>>.value(
              <String, dynamic>{},
