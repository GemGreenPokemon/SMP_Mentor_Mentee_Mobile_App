...
/// Manages tab visibility and coordinates API calls across multiple browser tabs
/// 
...
class TabVisibilityManager {
  // Singleton pattern
  static final TabVisibilityManager _instance = TabVisibilityManager._internal();
  factory TabVisibilityManager() => _instance;
  TabVisibilityManager._internal();
