...
class CloudFunctionInitializerDialog extends StatefulWidget {
  ...
  final CloudFunctionService cloudFunctions;
  ...
  const CloudFunctionInitializerDialog({
    super.key,
  ...
  @override
  State<CloudFunctionInitializerDialog> createState() => _CloudFunctionInitializerDialogState();
}

class _CloudFunctionInitializerDialogState extends State<CloudFunctionInitializerDialog> {
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              // Database Structure Preview Section
              Container(
  ...
  Future<void> _initializeViaCloudFunction() async {
    setState(() {
    ...
    try {
      ...
      try {
        result = await widget.cloudFunctions.initializeUniversity(
